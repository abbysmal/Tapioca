...
(* OASIS_START *)
(* DO NOT EDIT (digest: 43df26db31f5b631b820343831a113a0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Tapioca: A simple collaborative text editor experiment in OCaml";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("eliom-widgets.server", None);
                           FindlibPackage ("diff_match_patch", None)
                        ];
                   ...
                   {
                      lib_modules =
                        ["server/Client"; "Services"; "Edition"; "Main"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("eliom-widgets.client", None);
                           FindlibPackage ("diff_match_patch", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "tapioca.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Õ&\012\018n3bs\028ú+ØÅ[O¥";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
